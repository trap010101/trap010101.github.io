...
(() => {
  ...
  Promise.resolve()
    .then(() => loadScript('/data/streaming-jp-20260906.js?v=20260913-coverage7'))
    .then(() => loadScript('/data/streaming-us-20260906.js?v=20260913-coverage7'))
    .then(() => loadScript('/data/streaming-kr-20260908.js?v=20260913-coverage7'))
