...
const locales = {
  ko: {
    ...
    heading: "최근 업데이트",
    headingDescription: "NewAnime에 반영된 주요 기능 개선과 작품 정보 갱신 내역을 선별해 날짜별로 기록합니다.",
    kicker: "newani.me",
    languageLabel: "언어 선택",
    menu: "메뉴",
    menuUpdates: "업데이트",
  ...
  ja: {
    ...
    heading: "最近の更新",
    headingDescription: "NewAnimeに反映された主な機能改善と作品情報の更新を選別し、日付ごとに記録しています。",
    kicker: "newani.me",
    languageLabel: "言語を選択",
    menu: "メニュー",
    menuUpdates: "更新",
  ...
  en: {
    ...
    headingDescription: "A curated record of notable NewAnime improvements and title information updates, organized by date.",
    kicker: "newani.me",
